...
class HexapodCoppeliaSimZMQRobot: public DQ_BranchedCoppeliaSimZMQRobot
{
public:
    HexapodCoppeliaSimZMQRobot() = delete;
    HexapodCoppeliaSimZMQRobot(const std::string& robot_name,
        const std::shared_ptr<DQ_CoppeliaSimInterfaceZMQExperimental>&
            vrep_interface_sptr);
    virtual ~HexapodCoppeliaSimZMQRobot() = default;

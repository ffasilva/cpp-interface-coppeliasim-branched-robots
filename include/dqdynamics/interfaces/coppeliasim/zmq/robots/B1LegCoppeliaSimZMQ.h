...
class B1LegCoppeliaSimZMQ: public DQ_BranchedCoppeliaSimZMQRobot
{
public:
    B1LegCoppeliaSimZMQ() = delete;
    B1LegCoppeliaSimZMQ(const std::string& robot_name,
        const std::shared_ptr<DQ_CoppeliaSimInterfaceZMQExperimental>&
                            vrep_interface_sptr);
    virtual ~B1LegCoppeliaSimZMQ() = default;

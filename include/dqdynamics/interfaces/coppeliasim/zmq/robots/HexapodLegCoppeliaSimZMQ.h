...
class HexapodLegCoppeliaSimZMQ: public DQ_BranchedCoppeliaSimZMQRobot
{
public:
    HexapodLegCoppeliaSimZMQ() = delete;
    HexapodLegCoppeliaSimZMQ(const std::string& robot_name,
        const std::shared_ptr<DQ_CoppeliaSimInterfaceZMQExperimental>&
                            vrep_interface_sptr);
    virtual ~HexapodLegCoppeliaSimZMQ() = default;

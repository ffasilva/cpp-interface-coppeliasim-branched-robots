...
class LBR4pCoppeliaSimZMQRobot: public DQ_BranchedCoppeliaSimZMQRobot
{
public:
    LBR4pCoppeliaSimZMQRobot() = delete;
    LBR4pCoppeliaSimZMQRobot(const std::string& robot_name,
        const std::shared_ptr<DQ_CoppeliaSimInterfaceZMQExperimental>& vrep_interface_sptr);
    virtual ~LBR4pCoppeliaSimZMQRobot() = default;
